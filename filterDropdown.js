  ...
  let main = document.getElementById("main");
    ...
    <div class="filter">
        ...
        <div id="worksFilter" class="filter-content">
          <a href="#" onclick="allContent()">All</a>
          <a href="#" onclick="vpContent()">Virtual Production</a>
          <a href="#" onclick="gdContent()">Graphic Design</a>
          <a href="#" onclick="gamContent()">Games</a>
          <a href="#" onclick="vidContent()">Video</a>
          <a href="#" onclick="miscContent()">Misc.</a>
        </div>
      </div>
</div>
...
<div class="main-body-post"><video onclick="quickdraw()" loop autoplay aria-label="A game called 'QUICKDRAW' showcasing a cowboy standoff" muted class="main-body-post game" src="https://media.githubusercontent.com/media/mkt883/portfolio/main/images/posts/games/QUICKDRAW SHOWCASE.mp4" width="580px"></video><p>JavaScript (p5.js), Photoshop/Photopea</p></div>
<div class="main-body-post"><video onclick="waterBend()" loop autoplay aria-label="A VFX video of myself manipulating water like in Avatar the Last Airbender" muted class="main-body-post vfx" src="https://media.githubusercontent.com/media/mkt883/portfolio/main/images/posts/videos/Water bending my drink.mp4" width="600px"></video><p>After Effects, Premiere Pro</p></div>
<div class="main-body-post"><video onclick="stc()" loop autoplay muted class="main-body-post game" aria-label="A sidescroller/platformer game showcase where the protagonist is jumping across a sewer themed level" src="https://media.githubusercontent.com/media/mkt883/portfolio/main/images/posts/games/stc.mp4" width="450px"></video><p>Unity, Photoshop</p></div>
...
<div class="main-body-post"><video onclick="rasenganCatch()" loop autoplay muted class="main-body-post vfx" aria-label="A VFX video inspired by the anime Naruto where I play catch with my clone" src="https://media.githubusercontent.com/media/mkt883/portfolio/main/images/posts/videos/Rasengan Catch with Shadow Clone.mp4" width="450px"></video><p>After Effects, Premiere Pro</p></div>
